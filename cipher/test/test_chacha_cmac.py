...
""" test_chacha_cmac.py
    ...
    Tests for ChaCha CMAC
    (c) 2015 by Paul A. Lambert
...
from cryptopy.cipher.chacha_cmac import chacha_cmac, subkey

class TestVectorsNIST_SP_800_38B(unittest.TestCase):
    """ Test Vectors from NIST Special Publication 800-38B """
    
    def test_ChaCha_CMAC(self):
        """ Create test vectors and test basic functionality """

        # For Examples 1 to 4 below, the block cipher is the
        # ChaCha algorithm with the following 128 bit key:
