...
class Point(object):
    ...
    def __add__(self, other):  return self.curve.add_points(self, other)  
    def __neg__(self):         return self.curve.negate(self)
    def __sub__(self, other):  return self + -other
    def __mul__(self,other):   return self.curve.scalar_multiple(self,other)      
    ...
    def from_octetstring(self,octetstring):
        """ per http://tools.ietf.org/html/draft-jivsov-ecc-compact-00 """
        raise "to do"
