...
if __name__ == "__main__":
    ...
    # Streebog sbox from http://apmi.bsu.by/assets/files/std/belt-spec27.pdf
    streebog_sbox_string = """
    ...
    streebog_sbbytes = [int(byte_chars,16) for byte_chars in streebog_sbox_string.split()]
    print "Streebog non-linearity  (min, max) = ", sboxNonlinearity(streebog_sbbytes)

    # GOST R 34.11-2012   https://tools.ietf.org/html/rfc6986
    ...
    #print "GOST R 34.11-2012 'pi' non-linearity (min, max) = ", sboxNonlinearity(pi)
